...
*/ -}}
{{- define "eric-oss-app-lcm.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-app-lcm.mergeAnnotations" -}}
  {{- include "eric-oss-app-lcm.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-app-lcm.mergeLabels" -}}
  {{- include "eric-oss-app-lcm.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
