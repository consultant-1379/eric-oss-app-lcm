...
public class OtelConfiguration {
    ...
    public OtlpGrpcSpanExporter otlpExporterGrpc() {
        return OtlpGrpcSpanExporter.builder()
                .setEndpoint(environment.getProperty(AppLcmConstants.TRACING_ENDPOINT, AppLcmConstants.TRACING_ENDPOINT_GRPC))
                .build();
    }
    ...
    public OtlpHttpSpanExporter otlpExporterHttp() {
        return OtlpHttpSpanExporter.builder()
                .setEndpoint(environment.getProperty(AppLcmConstants.TRACING_ENDPOINT, AppLcmConstants.TRACING_ENDPOINT_HTTP))
                .build();
    }
    ...
    public JaegerRemoteSampler jaegerRemoteSampler() {
        return JaegerRemoteSampler.builder()
                .setEndpoint(environment.getProperty(AppLcmConstants.TRACING_JAEGER_ENDPOINT, AppLcmConstants.TRACING_JAEGER_ENDPOINT_GRPC))
                .setPollingInterval(Duration.ofSeconds(Long.parseLong(environment.getProperty(AppLcmConstants.TRACING_POLING,
                        AppLcmConstants.TRACING_POLING_INTERVAL))))
