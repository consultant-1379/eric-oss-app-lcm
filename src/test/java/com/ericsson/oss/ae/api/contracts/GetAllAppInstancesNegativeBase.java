...
public class GetAllAppInstancesNegativeBase {
    ...
    @BeforeEach
    public void setup() {
        given(service.getAllAppInstances(null))
                .willThrow(new ResourceNotFoundException(AppLcmError.SPECIFIED_APP_INSTANCE_NOT_FOUND, "App Instances not found", APP_INSTANCES));
