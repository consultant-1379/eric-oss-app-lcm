...
public class AcmDeleteAppInstanceByIdNegativeBase extends AcmAppInstancesBase {
    @Override
    public void validate() {
        given(service.deleteAppInstance("99999a99-9de9-9ad9-9999-999eefd99999")).willThrow(
            new AppLcmException(NOT_FOUND, APP_NOT_FOUND_ERROR));

        // 500 Internal Server Error
        given(service.deleteAppInstance("26471a81-1de4-4ad9-9724-326eefd22230")).willThrow(
            new AppLcmException(INTERNAL_SERVER_ERROR, DEFAULT_APP_LCM_ERROR));

        // 400 Bad Request
        given(service.deleteAppInstance("26471181-1d14-4119-9724-326111122230")).willThrow(
