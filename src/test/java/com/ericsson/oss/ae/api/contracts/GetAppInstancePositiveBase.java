...
public class GetAppInstancePositiveBase {
    ...
    @BeforeEach
    public void setup() {
        given(service.getAppInstance(any())).willReturn(getAppInstance());
    ...
    private AppInstanceDto getAppInstance() {
        ...
        result.setId(1L);
        result.setHealthStatus(HealthStatus.INSTANTIATED.name());
