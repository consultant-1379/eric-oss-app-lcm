...
def bob = new BobCommand()
    ...
    .envVars([
        ...
        EAPPLCM_ADP_MARKETPLACE_TOKEN: '${EAPPLCM_ADP_MARKETPLACE_TOKEN}',
...
pipeline {
    ...
    environment {
        ...
        EAPPLCM_ADP_MARKETPLACE_TOKEN = credentials('EAPPLCM_ADP_MARKETPLACE_TOKEN')
            ...
            steps {
                parallel(
                    ...
                    "Generate Docs": {
                        ...
                        sh "${bob} marketplace-upload-in-development"
